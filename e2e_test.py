...
# Attempt token refresh after creating app
if refresh:
    print('Refreshing token')
    code, refresh_resp = http_request('/api/users/token/refresh/', method='POST', data={'refresh': refresh})
    print('Refresh response:', code, refresh_resp)
